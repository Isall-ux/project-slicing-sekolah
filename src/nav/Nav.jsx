...
const Nav = () => {
  ...
  return (
    <div className="flex items-center justify-between px-4 sm:px-10 py-5 border-b-2 border-gray-200 w-full relative z-20">
      <nav className="flex items-center flex-row sticky top-0 w-full">
        <BrandLabel />
