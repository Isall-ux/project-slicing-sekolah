...
const Footer = () => {
  ...
  return (
    <footer className="p-6 text-white bg-blue-800 rounded w-full flex flex-col sm:flex-row items-center justify-between">
      ...
      <div className="flex flex-row space-x-3 order-2 mt-2">
